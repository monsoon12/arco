...
<!--    </a-row>-->
    ...
    <a-modal class="add-curriculum" align-center title-align="start" v-model:visible="visible" title="新增/修改用户权限" @cancel="handleCancel" @before-ok="handleBeforeOk">
