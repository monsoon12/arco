export default {
  ...
  'workplace.pecs': '个',
  'workplace.learning_crowd': '今日学习人数',
  'workplace.learning_duration': '今日学习时长',
  'workplace.learning_online': '今日在线人数',
  'workplace.curriculum_total': '课程总数',
  'workplace.subject_total': '试题总数',
  'workplace.examination_total': '考试总数',
};
