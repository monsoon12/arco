<template>
  <div class="container course-management">
    <Breadcrumb :items="['试卷管理', '试卷列表']" />
    <a-card class="general-card" >
<!--      <a-row :gutter="{xxl:24}" wrap justify="space-between">-->
<!--        <a-col  :xxl="22" :xl="21" :lg="20" :md="24" :sm="24" :xs="24" wrap>-->
<!--          <a-form-->
<!--              :model="formModel"-->
<!--              auto-label-width-->
<!--          >-->
<!--            <a-row  justify="space-between" wrap>-->
<!--              <a-col  :xxl="5" :xl="5" :lg="11" :md="11" :sm="24" :xs="24">-->
<!--                <a-form-item-->
<!--                    field="number"-->
<!--                    label="试卷名称"-->
<!--                >-->
...
<!--                </a-form-item>-->
<!--              </a-col>-->
<!--              <a-col  :xxl="4" :xl="6" :lg="11" :md="11" :sm="24" :xs="24">-->
<!--                <a-form-item-->
<!--                    field="contentType"-->
<!--                    label="状态"-->
<!--                >-->
...
<!--      </a-row>-->
      ...
      >
        ...
        <template #operations>
          ...
          <a-button  type="text" size="small">禁用</a-button>
...
<script lang="ts" setup>
  ...
  const typesStatus =  computed<SelectOptionData[]>(() => [
    {
      label: '已发布',
      value: '0',
    },
