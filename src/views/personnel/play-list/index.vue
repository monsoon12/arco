<template>
  <div class="container course-management">
    <Breadcrumb :items="['人员管理', '职位管理']" />
    <a-card class="general-card" >
<!--      <a-row :gutter="{xxl:24}" justify="space-between">-->
<!--        <a-col  :xxl="20" :xl="20" :lg="24" :md="24" :sm="24" :xs="24" wrap>-->
<!--          <a-form-->
<!--            :model="formModel"-->
<!--            auto-label-width-->
<!--          >-->
<!--            <a-row  justify="space-between" wrap>-->
<!--              <a-col  :xxl="6" :xl="6" :lg="6" :md="11" :sm="11" :xs="24">-->
<!--                <a-form-item-->
<!--                    field="contentType"-->
<!--                    label="公司"-->
<!--                >-->
...
<!--                </a-form-item>-->
<!--              </a-col>-->
<!--              <a-col  :xxl="{span:4}" :xl="4" :lg="4" :md="11" :sm="{span:11}" :xs="24" class="search-button-all" >-->
...
<!--    </a-row>-->
    ...
    <a-modal class="add-curriculum" align-center title-align="start" v-model:visible="visible" title="新增/修改职位" @cancel="handleCancel" @before-ok="handleBeforeOk">
